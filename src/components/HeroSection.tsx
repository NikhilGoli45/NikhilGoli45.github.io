...
const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col justify-between px-6 md:px-12 lg:px-20 py-32"
    >
      {/* Corner label */}
      {/* <div className="absolute top-8 right-6 md:right-12 lg:right-20">
